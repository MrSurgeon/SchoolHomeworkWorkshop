...
namespace MyCompany.School.HomeworkDemo.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(RoleManager<SchoolRole> roleManager)
        {
        ...
        //POST: Role Edit
        [HttpPost]
        public async Task<IActionResult> RoleEdit(int? id, AdminRoleAddModel roleAdminAddModel)
        {

            if (id.ToString() != roleAdminAddModel.Role.Id)
            {
